...
public class PrefixMergePolicy implements ILSMMergePolicy {
    ...
    public void diskComponentAdded(final ILSMIndex index, boolean fullMergeIsRequested) throws HyracksDataException {
        System.out.println("prefix merge policy disk component added");
    ...
    public void configure(Map<String, String> properties) {
        maxMergableComponentSize = Long.parseLong(properties.get("max-mergable-component-size")) * 1000;
        maxToleranceComponentCount = Integer.parseInt(properties.get("max-tolerance-component-count")) * 1;
    }
    ...
    protected Pair<Integer, Integer> getMergableComponentsIndex(List<ILSMDiskComponent> immutableComponents) {
        ...
        System.out.println("num components is " + numComponents);
        for (int i = 0; i < numComponents; i++) {
            ...
            if (j != numComponents) {
                System.out.println("Hit num components continue");
                continue;
            }
