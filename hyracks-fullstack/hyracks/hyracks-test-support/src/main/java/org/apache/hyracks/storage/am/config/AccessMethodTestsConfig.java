...
public class AccessMethodTestsConfig {
    ...
    public static final int RTREE_NUM_INSERT_ROUNDS = 1;
    public static final int RTREE_NUM_DELETE_ROUNDS = 1;
    public static final int RTREE_MULTITHREAD_NUM_OPERATIONS = 16; /////////////////////////////////
    //    public static final int RTREE_MULTITHREAD_NUM_OPERATIONS = 100000;	/////////////////////////////////
    ...
    public static final int RTREE_PAGE_SIZE = 2048;
    public static final int RTREE_NUM_PAGES = 262144;
    public static final int RTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    public static final int RTREE_HYRACKS_FRAME_SIZE = 2048;

    // Mem configuration for LSMRTree and LSMRTreeWithAntiMatterTuples.
    public static final int LSM_RTREE_DISK_PAGE_SIZE = 2048;
    public static final int LSM_RTREE_DISK_NUM_PAGES = 262144;
    public static final int LSM_RTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    public static final int LSM_RTREE_MEM_PAGE_SIZE = 2048;
    public static final int LSM_RTREE_MEM_NUM_PAGES = 131072;
    public static final int LSM_RTREE_HYRACKS_FRAME_SIZE = 2048;
    //public static final int LSM_RTREE_MEM_PAGE_SIZE = 512;
    //public static final int LSM_RTREE_MEM_NUM_PAGES = 16;
    //public static final int LSM_RTREE_HYRACKS_FRAME_SIZE = 512;
    public static final double LSM_RTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;

    // Mem configuration for BTree.
    public static final int BTREE_PAGE_SIZE = 2048;
    public static final int BTREE_NUM_PAGES = 262144;
    public static final int BTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    public static final int BTREE_HYRACKS_FRAME_SIZE = 2048;

    // Mem configuration for LSMBTree.
    public static final int LSM_BTREE_DISK_PAGE_SIZE = 2048;
    public static final int LSM_BTREE_DISK_NUM_PAGES = 262144;
    public static final int LSM_BTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    public static final int LSM_BTREE_MEM_PAGE_SIZE = 2048;
    //public static final int LSM_BTREE_MEM_NUM_PAGES = 131072; // default
    //public static final int LSM_BTREE_MEM_NUM_PAGES = 8192;
    //public static final int LSM_BTREE_MEM_NUM_PAGES = 32768;
    //public static final int LSM_BTREE_MEM_NUM_PAGES = 131072;
    public static final int LSM_BTREE_MEM_NUM_PAGES = 524288;
    public static final int LSM_BTREE_HYRACKS_FRAME_SIZE = 2048;
    public static final double LSM_BTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;
    //////    4K
    // // Mem configuration for RTree.
    //    public static final int RTREE_PAGE_SIZE = 4096;
    //    public static final int RTREE_NUM_PAGES = 1000;
    //    public static final int RTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //    public static final int RTREE_HYRACKS_FRAME_SIZE = 1024;
    //
    //    // Mem configuration for LSMRTree and LSMRTreeWithAntiMatterTuples.
    //    public static final int LSM_RTREE_DISK_PAGE_SIZE = 4096;
    //    public static final int LSM_RTREE_DISK_NUM_PAGES = 1000;
    //    public static final int LSM_RTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //    public static final int LSM_RTREE_MEM_PAGE_SIZE = 4096;
    //    public static final int LSM_RTREE_MEM_NUM_PAGES = 1000;
    //    public static final int LSM_RTREE_HYRACKS_FRAME_SIZE = 1024;
    //    public static final double LSM_RTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;
    //
    //    // Mem configuration for BTree.
    //    public static final int BTREE_PAGE_SIZE = 4096;
    //    public static final int BTREE_NUM_PAGES = 100;
    //    public static final int BTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //    public static final int BTREE_HYRACKS_FRAME_SIZE = 1024;
    //
    //    // Mem configuration for LSMBTree.
    //    public static final int LSM_BTREE_DISK_PAGE_SIZE = 4096;
    //    public static final int LSM_BTREE_DISK_NUM_PAGES = 1000;
    //    public static final int LSM_BTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //    public static final int LSM_BTREE_MEM_PAGE_SIZE = 4096;
    //    public static final int LSM_BTREE_MEM_NUM_PAGES = 100;
    //    public static final int LSM_BTREE_HYRACKS_FRAME_SIZE = 1024;
    //    public static final double LSM_BTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;

    //  //8K,
    //  //Mem configuration for RTree.
    //  public static final int RTREE_PAGE_SIZE = 8200;
    //  public static final int RTREE_NUM_PAGES = 1000;
    //  public static final int RTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //  public static final int RTREE_HYRACKS_FRAME_SIZE = 2048;
    //
    //  // Mem configuration for LSMRTree and LSMRTreeWithAntiMatterTuples.
    //  public static final int LSM_RTREE_DISK_PAGE_SIZE = 8200;
    //  public static final int LSM_RTREE_DISK_NUM_PAGES = 1000;
    //  public static final int LSM_RTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //  public static final int LSM_RTREE_MEM_PAGE_SIZE = 8200;
    //  public static final int LSM_RTREE_MEM_NUM_PAGES = 1000;
    //  public static final int LSM_RTREE_HYRACKS_FRAME_SIZE = 2048;
    //  public static final double LSM_RTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;
    //
    //  // Mem configuration for BTree.
    //  public static final int BTREE_PAGE_SIZE = 8200;
    //  public static final int BTREE_NUM_PAGES = 100;
    //  public static final int BTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //  public static final int BTREE_HYRACKS_FRAME_SIZE = 2048;
    //
    //  // Mem configuration for LSMBTree.
    //  public static final int LSM_BTREE_DISK_PAGE_SIZE = 8200;
    //  public static final int LSM_BTREE_DISK_NUM_PAGES = 1000;
    //  public static final int LSM_BTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //  public static final int LSM_BTREE_MEM_PAGE_SIZE = 8200;
    //  public static final int LSM_BTREE_MEM_NUM_PAGES = 100;
    //  public static final int LSM_BTREE_HYRACKS_FRAME_SIZE = 2048;
    //  public static final double LSM_BTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;
    ...
    ////32K
    //// Mem configuration for RTree.
    //public static final int RTREE_PAGE_SIZE = 32768;
    //public static final int RTREE_NUM_PAGES = 1000;
    //public static final int RTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //public static final int RTREE_HYRACKS_FRAME_SIZE = 8192;
    //
    //// Mem configuration for LSMRTree and LSMRTreeWithAntiMatterTuples.
    //public static final int LSM_RTREE_DISK_PAGE_SIZE = 32768;
    //public static final int LSM_RTREE_DISK_NUM_PAGES = 1000;
    //public static final int LSM_RTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //public static final int LSM_RTREE_MEM_PAGE_SIZE = 32768;
    //public static final int LSM_RTREE_MEM_NUM_PAGES = 1000;
    //public static final int LSM_RTREE_HYRACKS_FRAME_SIZE = 8192;
    //public static final double LSM_RTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;
    //
    //// Mem configuration for BTree.
    //public static final int BTREE_PAGE_SIZE = 32768;
    //public static final int BTREE_NUM_PAGES = 100;
    //public static final int BTREE_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //public static final int BTREE_HYRACKS_FRAME_SIZE = 8192;
    //
    //// Mem configuration for LSMBTree.
    //public static final int LSM_BTREE_DISK_PAGE_SIZE = 32768;
    //public static final int LSM_BTREE_DISK_NUM_PAGES = 1000;
    //public static final int LSM_BTREE_DISK_MAX_OPEN_FILES = Integer.MAX_VALUE;
    //public static final int LSM_BTREE_MEM_PAGE_SIZE = 32768;
    //public static final int LSM_BTREE_MEM_NUM_PAGES = 100;
    //public static final int LSM_BTREE_HYRACKS_FRAME_SIZE = 8192;
    //public static final double LSM_BTREE_BLOOMFILTER_FALSE_POSITIVE_RATE = 0.01;
