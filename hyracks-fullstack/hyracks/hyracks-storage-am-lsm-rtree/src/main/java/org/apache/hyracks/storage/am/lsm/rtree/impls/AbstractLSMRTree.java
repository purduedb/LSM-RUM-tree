...
public abstract class AbstractLSMRTree extends AbstractLSMIndex implements ITreeIndex {
    ...
    public AbstractLSMRTree(IIOManager ioManager, List<IVirtualBufferCache> virtualBufferCaches,
            ...
            int[] rtreeFields, int[] filterFields, boolean durable, boolean isPointMBR, UpdateMemo<Integer> globalUM)
        ...
        for (IVirtualBufferCache virtualBufferCache : virtualBufferCaches) {
            ...
            if (isLocalUM()) {
                ...
                mutableComponent = new LSMRTreeMemoryComponent(this, memRTree, memBTree, virtualBufferCache,
                        filterHelper == null ? null : filterHelper.createFilter(), localUM);
            } else {
                mutableComponent = new LSMRTreeMemoryComponent(this, memRTree, memBTree, virtualBufferCache,
                        filterHelper == null ? null : filterHelper.createFilter(), null);
            }
