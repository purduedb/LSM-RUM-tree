...
public class RTreeSecondaryIndexInsertOperatorTest extends AbstractRTreeOperatorTest {
    ...
    public void setup() throws Exception {
        ...
        loadSecondaryIndex();
        insertPipeline();
        System.out.println("JW-RTreeSecondaryIndexInsertOperatorTest-setup()");
    }

    @Test
    public void searchUpdatedSecondaryIndexTest() throws Exception {
        System.out.println("JW-RTreeSecondaryIndexInsertOperatorTest-searchUpdatedSecondaryIndexTest()");
