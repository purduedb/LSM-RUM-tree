...
public class LSMBTreeTestHarness {
    ...
    public LSMBTreeTestHarness() {
        ...
        if (UpdateMemoConfig.SELECTED_MERGE_POLICY.equals("no-merge")) {
            this.mergePolicy = new NoMergePolicy();
        } else if (UpdateMemoConfig.SELECTED_MERGE_POLICY.equals("constant-merge")) {
            this.mergePolicy = new ConstantMergePolicy();
            Map<String, String> properties = new HashMap<String, String>();
            properties.put("num-components", UpdateMemoConfig.NUM_COMPONENTS);
            this.mergePolicy.configure(properties);
        } else if (UpdateMemoConfig.SELECTED_MERGE_POLICY.equals("prefix")) {
            this.mergePolicy = new PrefixMergePolicy();
            Map<String, String> properties = new HashMap<String, String>();
            properties.put("max-mergable-component-size", String.valueOf(UpdateMemoConfig.MERGABLE));
            properties.put("max-tolerance-component-count", String.valueOf(UpdateMemoConfig.NUM_COMPONENTS));
            this.mergePolicy.configure(properties);
        } else if (UpdateMemoConfig.SELECTED_MERGE_POLICY.equals("concurrent-merge")) {
            this.mergePolicy = new ConcurrentMergePolicy();
        }
        LOGGER.info(this.mergePolicy);
