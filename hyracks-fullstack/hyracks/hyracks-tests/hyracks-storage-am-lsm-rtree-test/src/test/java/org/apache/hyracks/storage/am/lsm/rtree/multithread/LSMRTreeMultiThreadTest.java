...
public class LSMRTreeMultiThreadTest extends AbstractRTreeMultiThreadTest {
    ...
    protected ArrayList<TestWorkloadConf> getTestWorkloadConf() {
        ...
        // Inserts and deletes.
        TestOperation[] insertDeleteOps = new TestOperation[] { TestOperation.INSERT, TestOperation.UPDATE };
        workloadConfs.add(
    ...
    public static void main(String[] args) throws Exception {
        LSMRTreeMultiThreadTest test = new LSMRTreeMultiThreadTest();
        test.rtreeTwoDimensionsDouble();
    }
